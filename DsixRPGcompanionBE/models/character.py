...
class Character(models.Model):
    ...
    physical_description = models.CharField(max_length=1369, null=True, blank=True)
    personality = models.CharField(max_length=1369, null=True, blank=True)
    background = models.CharField(max_length=1369, null=True, blank=True)
    objectives = models.CharField(max_length=1369, null=True, blank=True)
    a_quote = models.CharField(max_length=1369, null=True, blank=True)
