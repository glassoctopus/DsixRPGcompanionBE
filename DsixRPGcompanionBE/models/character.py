...
class Character(models.Model):
    ...
    dexterity = models.DecimalField(max_digits=3, decimal_places=1)
    knowledge = models.DecimalField(max_digits=3, decimal_places=1)
    mechanical = models.DecimalField(max_digits=3, decimal_places=1)
    perception = models.DecimalField(max_digits=3, decimal_places=1)
    strength = models.DecimalField(max_digits=3, decimal_places=1)
    technical = models.DecimalField(max_digits=3, decimal_places=1)
    force_control = models.DecimalField(max_digits=3, decimal_places=1)
    force_sense = models.DecimalField(max_digits=3, decimal_places=1)
    force_alter = models.DecimalField(max_digits=3, decimal_places=1)
    force_points = models.DecimalField(max_digits=3, decimal_places=1)
    dark_side_points = models.DecimalField(max_digits=3, decimal_places=1)
    force_strength = models.DecimalField(max_digits=3, decimal_places=1)
