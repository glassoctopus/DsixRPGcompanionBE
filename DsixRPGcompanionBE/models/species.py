...
class Species(models.Model):
    ...
    species_average_height = models.DecimalField(max_digits=6, decimal_places=1, null=True, blank=True)
    species_average_weight = models.DecimalField(max_digits=6, decimal_places=1, null=True, blank=True)
    ...
    species_physical_description = models.CharField(max_length=3696, null=True, blank=True)
    species_personality = models.CharField(max_length=3696, null=True, blank=True)
    species_background = models.CharField(max_length=3696, null=True, blank=True)
